...
module Correctness.RegExp-eNFA.Concatenation-lemmas (Σ : Set)(dec : DecEq Σ)(e₁ : RegularExpression.RegExp Σ dec)(e₂ : RegularExpression.RegExp Σ dec) where
...
module Lᴿ⊆Lᴺ where
  ...
  lem₁ {w} {u} {v} w≡uv (uᵉ , u≡uᵉ , q₁ , q₁∈F₁ , prf₁) (vᵉ , v≡vᵉ , q₂ , q₂∈F₂ , prf₂)
    = uᵉ ++ E ∷ E ∷ vᵉ , Σᵉ*-lem₇ w u v uᵉ vᵉ w≡uv u≡uᵉ v≡vᵉ , ⍟inj₂ q₂ , q₂∈F₂ , lem₂ uᵉ q₁ vᵉ q₂ q₁∈F₁ prf₁ prf₂
...
module Lᴿ⊇Lᴺ where
  ...
  ... | n , m , vᵉ , prf₁ , prf₂
    = toΣ* uᵉ , toΣ* vᵉ , lem₃ wᵉ n vᵉ prf₁ , lem₉ q vᵉ m q∈F prf₂ , trans w≡wᵉ (Σᵉ*-lem₈ wᵉ uᵉ vᵉ (lem₁₁ q₀ wᵉ n mid vᵉ prf₁))
    where
      uᵉ : Σᵉ*
