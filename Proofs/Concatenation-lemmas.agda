...
open NFA nfa
open NFA nfa₁ renaming (Q to Q₁ ; δ to δ₁ ; q₀ to q₀₁ ; F to F₁)
open NFA nfa₂ renaming (Q to Q₂ ; δ to δ₂ ; q₀ to q₀₂ ; F to F₂)
open NFA-Operations nfa
open NFA-Operations nfa₁ renaming (_⊢_ to _⊢ₑ₁_ ; _⊢*_ to _⊢*ₑ₁_ ; _⊢ᵏ_─_ to _⊢ᵏₑ₁_─_ ; ⊢*₂→⊢* to ⊢*₂→⊢*ₑ₁ )
open NFA-Operations nfa₂ renaming (_⊢_ to _⊢ₑ₂_ ; _⊢*_ to _⊢*ₑ₂_ ; _⊢ᵏ_─_ to _⊢ᵏₑ₂_─_ ; ⊢*₂→⊢* to ⊢*₂→⊢*ₑ₂ )
...
lem₁ : ∀ w w₁ w₂ → w ≡ w₁ ++ w₂ → w₁ ∈ Lᴺ nfa₁ → w₂ ∈ Lᴺ nfa₂ → w ∈ Lᴺ nfa
