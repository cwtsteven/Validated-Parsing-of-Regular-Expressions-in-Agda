...
\cite{firsov2013} represent the set of states \mb{Q} and its subsets
...
to represent the sets in an abstract form. In our approach, the set of states are represented as a data type in Agda, i.e. \mb{Q : Set}, and its
...
\paragraph{Correctness} Traditionally, when a mathematicians submit
